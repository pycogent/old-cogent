#!/usr/bin/env python
#file test_organizer.py

"""Tests Filter, Organizer and filterfunctions, classes for filtering

Revision History

10/20/03 Sandra Smit: moved from test_filters into this file

10/28/03 Sandra Smit: rewritten organizer tests into separate functions

10/28/03 Sandra Smit: added test function for call functionality of Filter
                      added test class for GroupList

12/06/04 Sandra Smit: added test for function 'regroup'
"""

from old_cogent.util.organizer import Filter, Organizer, GroupList, regroup
from old_cogent.util.transform import find_any, find_no, find_all,\
