#!/usr/bin/env python
#file: cogent_tests/format/test_mage.py
"""file test_mage.py
...
Updated 10/28-30/03 by Rob Knight: includes new tests for MagePointFromString
and MagePointFromBaseFreqs.

8/16/04 Sandra Smit: changed and added tests to test the new functionality (see
mage.py
8/19/04 Sandra Smit: added tests for toCartesian and fromCartesian 
functionality
09/20/04 Sandra Smit: changed tests for MagePoint toCartesian and MageList 
toCartesian to check for ValueError.
2/23/06 Sandra Smit: added small test to fromCartesian.
"""
from Numeric import array
from __future__ import division
from copy import deepcopy
from old_cogent.util.unit_test import TestCase, main
from old_cogent.format.mage import MagePoint, MageList, MageGroup, MageHeader, \
    Kinemage, MagePointFromBaseFreqs
from old_cogent.base.usage import BaseUsage
