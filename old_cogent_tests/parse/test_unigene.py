#!/usr/bin/env python
#file evo/parsers/test_unigene.py
...
10/23/03 Rob Knight: updated some field names. Removed debug code.
"""

from old_cogent.parse.unigene import _read_sts, _read_expression, UniGeneSeqRecord,\
