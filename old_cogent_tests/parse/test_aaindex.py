...
10/02/03 Greg Caporaso: AAIndex1Parser, AAIndex2Parser tests

10/07/03 Greg Caporaso: updata getField to handle multi line comments that
continue when line breaks with a '*' character

10/22/03 Greg Caporaso: Updated to test proper building of matrices of data as
2D dicts

10/31/03 Greg Caporaso: Added test for AAIndexRecord, AAIndex1Record,
AAIndex2Record
"""

from old_cogent.util.unit_test import TestCase, main
from old_cogent.parse.aaindex import AAIndex1Parser, AAIndex2Parser,\
