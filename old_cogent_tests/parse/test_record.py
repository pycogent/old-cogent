#!/usr/bin/env python
#file evo/parsers/test_record.py
...
10/9/03 Rob Knight: initially written.

10/22/03 Rob Knight: updated for string_and_strip, FieldWrapper, 
StrictFieldWrapper, raise_unknown_field, FieldMorpher, and for negative
indices in DelimitedSplitter.

10/24/03 Rob Knight: added list_extender

10/26/03 Rob Knight: Renamed GenericRecord to MappedRecord. Added more generic
GenericRecord.

11/6/03 Rob Knight: added some tests to ensure that MappedRecord subclasses
interact correctly with class data.
"""
from old_cogent.parse.record import FieldError, RecordError, Grouper, \
