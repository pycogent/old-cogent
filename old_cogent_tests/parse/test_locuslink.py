#!/usr/bin/env python
#file evo/parsers/test_locuslink.py
...
10/23/03 Rob Knight: initially written.
"""
from old_cogent.parse.locuslink import ll_start,LLFinder,pipes,first_pipe,commas, \
