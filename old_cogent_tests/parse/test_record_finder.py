#!/usr/bin/env python
#file evo/parsers/test_record_finder.py
...
10/22/03 Rob Knight: added LabeledRecordFinder, LineGrouper

01/29/06 Zongzhi Liu: modified DelimitedRecordFinderTests to add test for the
rew parameters (keep_delimiter, strict).

02/22/06 Zongzhi Liu: added tests for TailedRecordFinder.
"""
