#!/usr/bin/env python
#file cogent_tests/parse/test_rna_fold.py
...
Written 10/7/04 by Jeremy Widmann.

10/19/04 Jeremy Widmann: Changed test_getSequence function reflecting change to
    getSequence in rna_fold.py which explicitly removes the trailing backslash
    from each sequence line rather than remove all non-alpha characters.
"""
from __future__ import division
from old_cogent.util.unit_test import TestCase, main
from old_cogent.parse.rna_fold import *
