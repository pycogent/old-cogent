#!/usr/bin/env python
#file: cogent_tests/maths/test_geometry
"""
Revision History:
8/16/04 Sandra Smit: written CenterOfMassTests

9/30/04 Rob Knight: added test for distance
"""

from Numeric import array,take,NewAxis
from math import sqrt
from old_cogent.util.unit_test import TestCase, main
from old_cogent.maths.geometry import center_of_mass_one_array,\
