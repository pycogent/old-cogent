#!/usr/bin/env python
#file cogent_tests/maths/stats/test_special.py
...
9/17/03 Rob Knight: started new unit tests for special functions.

10/14/03 Rob Knight: changed imports

11/1/03 Rob Knight: added tests for permutations and combinations

7/26/05 Rob Knight: added tests for igami and ndtri.
7/27/05 Rob knight: added test for log1p, which was incorrect.

1/17/06 Sandra Smit: Added tests for permutations and combinations and changed
tests for permutations_lgam and combinations_lgam into tests for the 
ln_permutations and ln_combinations functions. Added test for the errors. 
Added several tests for ln_binomial.
"""

from old_cogent.util.unit_test import TestCase, main
from old_cogent.maths.stats.special import permutations, permutations_exact, \
