#!/usr/bin/env python
# file cogent/base/test_usage.py
...
9/20/03 Rob Knight: originally written for PyEvolve.

11/5/03 Rob Knight: completed tests for InfoFreqs, AminoAcidUsage, BaseUsage,
CodonUsage, and PositionalBaseUsage.

12/28/03 Rob Knight: moved into stats

5/19/04 Sandra Smit: added test for BaseUsage.distance()

6/8/04 Rob Knight: added test for BaseUsage.distance U/T polymorphism, for
BaseUsage.functionality(), and for UnsafeBaseUsage.

7/14/05 Rob Knight: added tests for CodonUsage.positionalGC, pr2bias, 
fingerprint.
"""
from __future__ import division
from old_cogent.util.unit_test import TestCase, main
from old_cogent.util.misc import FunctionWrapper
from old_cogent.base.usage import InfoFreqs, AminoAcidUsage, BaseUsage, CodonUsage,\
    PositionalBaseUsage, UnsafeBaseUsage, EqualBases, DinucUsage
from old_cogent.base.genetic_code import GeneticCodes, GeneticCode
