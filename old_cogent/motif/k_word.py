#!/usr/bin/env python
#file cogent.motif.k_word.py

from old_cogent.motif.util import *
from old_cogent.base.bitvector import PackedBases
from old_cogent.maths.stats.test import combinations, multiple_comparisons
from old_cogent.maths.stats.distribution import poisson_high
from Numeric import array,fromstring
...
June 2005 Jeremy Widmann.  Moved over to new API.

March 2006 Jeremy Widmann.  Added KWordModuleConsolidatorNucleotide and
    KWordModuleConsolidatorProtein.
"""
...
class KWordModuleFinder(ModuleFinder):
    ...
    def __init__(self,Alignment,Alphabet):
        ...
        self.make_char_array_aln()
    
    def make_char_array_aln(self):
    ...
    def __call__(self,word_length):
        ...
        #Get list of counts
        module_counts = \
            [(len(mod),word) for word,mod in self.ModuleDict.items()]
