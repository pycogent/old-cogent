#!/usr/bin/env python
# file cogent/align/algorithm.py
"""Code for performing alignments.
...
10/17/03 Rob Knight: Initially wrote the Smith-Waterman and Needleman-Wunsch
algorithms, modeled on the implementations on pp 40-49 of Korf, Yandell
& Bedell (2003), "BLAST" (except that these are object-oriented and in
Python instead of Perl...)

12/28/03 Rob Knight: changed file name to evo/alignments/algorithm.py

12/22/04 Jeremy Widmann:  Changed ScoreCell's update function.  In case of a tie
update will pick up, diag, then left rather than diag, up, then left as it previously was."""
