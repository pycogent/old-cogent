...
2/11/03 Rob Knight: changed import to cogent.base.usage
"""
...
from old_cogent.util.misc import caps_from_underscores as cfu
from old_cogent.base.usage import CodonUsage
