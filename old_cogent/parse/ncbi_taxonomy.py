#!/usr/bin/env python
#file evo/parsers/ncbi_taxonomy.py
"""Extracts data from NCBI nodes.dmp and names.dmp files.

Owner: Jason Carnes jason.carnes@sbri.org

Status: Development

Revision History

written by Jason Carnes 7-25-2003; last modification 8-19-2003

10/29/03 Rob Knight: Changed interface, updated for additional fields,
integrated into PyEvolve. Now uses cogent.base.tree.TreeNode, providing many
