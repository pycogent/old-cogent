...
10/9/03 Rob Knight: initially written. Remember to delete debug code in the
subclasses of MappedRecord once all the fields in the files have been
discovered! (marked with ***)

10/22/03 Rob Knight: updated imports

10/23/03 Rob Knight: deleted debug code and changed field names.
"""
from old_cogent.parse.record import MappedRecord, ByPairs, semi_splitter, \
    equal_pairs, LineOrientedConstructor, list_adder, int_setter
from old_cogent.parse.record_finder import GbFinder
