...
10/22/03 Rob Knight: initially written according to LocusLink README.

10/23/03 Rob Knight: extensively revised after writing test scripts to discover
what's actually _in_ the LL_out file.

10/26/03 Restored fieldmap. Now uses LineOrientedConstructor: loses some 
potential associations stored as positional information, but given the
inconsistencies in the file format it is probably impossible to get these
anyway.
"""
from old_cogent.parse.record import MappedRecord, FieldWrapper, DelimitedSplitter,\
