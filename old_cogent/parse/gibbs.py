...
"""Parses Gibbs Sampler output file and creates Module objects.
...
Written June 2006 by Jeremy Widmann.

6/20/2006 - Micah Hamady - Hacked to get working w/web stuff (Note truncate_len parameter to make ids look the same as meme ids) - this should get refactored and moved into cogent at some point.

11/17/2006 - Micah Hamady - Fixed major bug where multiple motifs of a given length were being skipped and or mislabeled. E.g. when multiple motifs of a certain length, they are numbered "Motif x, number y". Previously, just x was being considered. 
