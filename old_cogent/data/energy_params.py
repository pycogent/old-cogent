...
Revision History:
10/07/03 Amanda Birmingham: started as helper for Primer class melting temp
    calculations
10/08/03 Amanda Birmingham: reordered class and instance creation b/c class
    has to be declared in module before a module of it can be created
    (outside a function.)
01/20/04 Amanda Birmingham: updated to fit into cvsroot.
"""
