...
7/28/2005 Micah Hamady: Initial Prototype

11/29/05 Sandra Smit: quickly added tree2 option to _get_result_paths. 

12/20/06 Cathy Lozupone: added aln_tree_seqs.

01/10/06 Zongzhi Liu: add a few docstrings to muscle_seqs

01/25/2006 Mike Robeson: added '-physout' and '-physiout'
ValuedParameters so you can write output as phylip sequential
or interleaved format. These only work for muscle v3.6 or later! 

01/27/2006 Mike Robeson: added '-diags' parameter
...
from old_cogent.app.blast import guess_input_handler
