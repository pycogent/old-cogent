...
10/17/03 Sandra Smit: separated from evo/filters.py. Changed 'Classifier'
to 'Organizer'.

10/28/03 Sandra Smit: fixed the Organizer criterion application. Now it
can handle multiple filters with possibly multiple functions per
object or attribute.

12/06/04 Sandra Smit: added function regroup, that can regroup lists with 
identical hierarchy-info together.
"""
class Filter(dict):
